...
| `correction.historique[]` | `{version, statut, raison, horodatage_utc, source, classement}` | Raisons : `INITIAL`, `PROVISOIRE_VERS_DEFINITIVE`, `COMPLETION`, `CONFIRMATION_DEFINITIVE`, `CORRECTION_CLASSEMENT`, `ANNULATION`, `MIGRATION_LEGACY` |
